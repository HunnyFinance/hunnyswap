// Root file: contracts/Calculator.sol
            ...
            uint(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex"e07ba483daac2c58ac75fdf640219c6e6d3f4365e1d82e06533751a8c25d2337" // init code hash
                    )
                )
            )
        );
...
contract Calculator {
    ...
    function update(address tokenA, address tokenB) external {
        ...
        require(timeElapsed >= CYCLE, "Calculator: PERIOD_NOT_ELAPSED");
